...
required_params = ['username', 'password', 'dateJoined', 'email', 'numWifiAdded']
...
def lambda_handler(event, context):
    ...
    # 6) GET and UPDATE (or POST or PUT) /networks/{marker_id+}            -> GET full info of a specific marker / UPDATE the data of the speicific marker

    elif req_type['request'] == 'UPDATE':
        return 
